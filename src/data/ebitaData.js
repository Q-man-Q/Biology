...
export const BIOTOPES_LIST = [
  "Степной участок (Ковыльно-типчаковая степь)",
  "Речная долина (Пойма реки Эбита)",
  "Кустарниковые заросли (Караганники)",
  "Мелкосопочник (Каменистые гряды)",
  "Солонец / Солончак",
  "Искусственные насаждения / Лесополоса"
];
