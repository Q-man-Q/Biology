      ...
      <div className="flex items-center gap-2">
        {user ? (
          <>
            ...
            {/* Add Observation button for authenticated users */}
            <button
          ...
          <>
            {/* Read-Only Guest Badge */}
            <div className="hidden sm:flex items-center gap-1 text-[11px] text-amber-300/80 bg-amber-950/40 border border-amber-500/20 px-2.5 py-1.5 rounded-xl">
